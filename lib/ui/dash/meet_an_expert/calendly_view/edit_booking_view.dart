...
class EditBookingView extends StatefulWidget {
  const EditBookingView({Key? key, required this.rescheduleLink, required this.communityId, required this.host, required this.refresh, required this.back}) : super(key: key);
  final String rescheduleLink;
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: _error != null? Center(
          ...
          initialUrl: Uri.encodeFull("${widget.rescheduleLink}?utm_content=${jsonEncode({
